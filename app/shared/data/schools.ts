...
export const schools: Degree[] = [
  {
    ...
    courses: [
      ...
      },
      {
        ...
        courseNum: 'CSCI 6600',
        title:
          'Selected Topics in Computer Science: Cloud Computing for Data Analysis',
      },
      {
        courseType: CourseType.SupportCourses,
        courseNum: 'CSCI 7850',
  ...
  },
  {
    ...
    schoolPhoto: lsuscampus,
    schoolLink:
      'https://www.lsus.edu/academics/graduate-studies/master-of-business-administration',
  ...
  {
    schoolName: 'Middle Tennessee State University',
    schoolPhoto: mtsucampus,
    schoolLink:
      'https://www.mtsu.edu/program/computer-science-professional-computer-science-concentration-b-s/',
