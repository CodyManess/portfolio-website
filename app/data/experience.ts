...
import cignaLogo from "../assets/cigna.webp"
import mtsuLogo from "../assets/mtsu.png"
...
export const roles: Array<Role> = [
    ...
    },
    {
        ...
        companyName: "The Cigna Group",
        companyLogo: cignaLogo.src,
        description: "- Worked on a scrum-based team to maintain and develop new features for a React web application called the Military Treatment Facility (MTF) Provider Portal, a secure web portal for Department of Defense prescribers. \n - Assisted with the development of two major releases to update the user-interface and add new features to meet business needs."
    },
]